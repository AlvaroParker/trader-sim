...
export default function Sidebar({
  ...
  return (
    <div className="md:h-full">
      ...
      <aside
        className={`z-40 transform top-0 left-0 w-64 bg-white border-r dark:bg-gray-900 dark:border-gray-700 fixed h-full pt-5 pb-10 flex flex-col overflow-y-auto transition-transform duration-200
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h4 className="mt-3 text-lg font-medium text-gray-800 dark:text-gray-200">{name}</h4>
        ...
        <div className="flex flex-col space-y-2 md:space-y-4">
          ...
          <a className="flex items-center px-4 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700" href="#">
            <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/api/auth/logout" className="absolute bottom-0 w-full px-4 py-2 text-gray-700 bg-white rounded-lg dark:bg-gray-900 dark:text-gray-200 dark:hover:bg-gray-800 hover:bg-gray-100 flex items-center">
          <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
